...
interface NewUser {
  _id: string;
  username: string;
  // Add any other properties you expect newUser to have
}
...
export class AuthService {
  ...
  async signIn(data: AuthDto) {
    ...
    // Ensure tokens.refreshToken is treated as a string
    const refreshToken: string = tokens.refreshToken;

    await this.updateRefreshToken(user._id as string, refreshToken);
    return tokens;
  }
